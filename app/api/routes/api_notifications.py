...
@router.get("/api/notifications/unread", summary="Get unread notifications count and recent alerts")
...
@router.post("/api/notifications/{notification_id}/read", summary="Mark single notification as read via API")
def mark_alert_read(notification_id: int, db: Session = Depends(get_db_session)) -> dict[str, Any]:
